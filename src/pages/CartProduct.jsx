...
const CartProduct = ({product,increaseQuantity,decreaseQuantity,removeProduct}) => {
    return (
        <div>
            <div className="rounded-3xl border-2 bg-white border-gray-200 p-4 lg:p-8 grid grid-cols-12 mb-8 max-lg:max-w-lg max-lg:mx-auto gap-y-4 w-[80%] mx-auto ">
                    ...
                    <div className="col-span-12 lg:col-span-10 detail w-full lg:pl-3">
                        <div className="flex items-center justify-between w-full mb-4">
                            ...
                            <button className="rounded-full group flex items-center justify-center focus-within:outline-red-500" onClick={()=>{
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <h6 className="text-indigo-600 font-manrope font-bold text-2xl leading-9 text-right">${product.productPrice.toFixed(2)}</h6>
                        </div>
                    </div>
                </div>
        </div>
